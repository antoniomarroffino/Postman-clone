    ...
    return (
        <div className="flex flex-col gap-2 flex-1 border-t border-base-300 pt-4">
            {(state.response || state.error) && (
                <div className="flex justify-between items-center p-2 bg-base-200 rounded-lg shadow-sm">
            ...
            {state.response && (
                <pre className="bg-base-200 p-4 rounded-lg overflow-auto flex-1 border border-base-300">
                    {state.response.data}
                </pre>
            )}
